...
public class GlazedBlocks {
	...
	public static RegistryObject<Block> GLAZED_TERRACOTTA_PILLAR_SIDE_SLAB;
	...
	*/
	...
	public static void register() {
        ...
        if (ModList.get().isLoaded("clayworks")) {
        	CENTERED_GLAZED_TERRACOTTA = HELPER.createBlock("centered_glazed_terracotta", () -> new GlazedTerracottaBlock(GlazedTerracottaProperties(Blocks.TERRACOTTA.defaultMapColor().toString())));
        	GLAZED_TERRACOTTA_PILLAR = HELPER.createBlock("glazed_terracotta_pillar", () -> new RotatedPillarBlock(GlazedTerracottaProperties(Blocks.TERRACOTTA.defaultMapColor().toString())));
        	GLAZED_TERRACOTTA_SLAB = HELPER.createBlock("glazed_terracotta_slab", () -> new GlazedSlabBlock(GlazedTerracottaProperties(Blocks.TERRACOTTA.defaultMapColor().toString())));
        	GLAZED_TERRACOTTA_PILLAR_SLAB = HELPER.createBlock("glazed_terracotta_pillar_slab", () -> new SlabBlock(GlazedTerracottaProperties(Blocks.TERRACOTTA.defaultMapColor().toString())));
        	GLAZED_TERRACOTTA_PILLAR_SIDE_SLAB = HELPER.createBlock("glazed_terracotta_pillar_side_slab", () -> new GlazedSlabBlock(GlazedTerracottaProperties(Blocks.TERRACOTTA.defaultMapColor().toString())));
        	CENTERED_GLAZED_TERRACOTTA_SLAB = HELPER.createBlock("centered_glazed_terracotta_slab", () -> new SlabBlock(GlazedTerracottaProperties(Blocks.TERRACOTTA.defaultMapColor().toString())));
