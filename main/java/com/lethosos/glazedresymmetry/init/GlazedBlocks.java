...
public class GlazedBlocks {
	...
	public static RegistryObject<Block> WHITE_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB = HELPER.createBlock("white_glazed_terracotta_side_pillar_slab", () -> new GlazedSlabBlock(GlazedTerracottaProperties("white")));
	...
	public static RegistryObject<Block> LIGHT_GRAY_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB = HELPER.createBlock("light_gray_glazed_terracotta_side_pillar_slab", () -> new GlazedSlabBlock(GlazedTerracottaProperties("light_gray")));
	...
	public static RegistryObject<Block> GRAY_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB = HELPER.createBlock("gray_glazed_terracotta_side_pillar_slab", () -> new GlazedSlabBlock(GlazedTerracottaProperties("gray")));
	...
	public static RegistryObject<Block> BLACK_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB = HELPER.createBlock("black_glazed_terracotta_side_pillar_slab", () -> new GlazedSlabBlock(GlazedTerracottaProperties("black")));
	...
	public static RegistryObject<Block> BROWN_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB = HELPER.createBlock("brown_glazed_terracotta_side_pillar_slab", () -> new GlazedSlabBlock(GlazedTerracottaProperties("brown")));
	...
	public static RegistryObject<Block> RED_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB = HELPER.createBlock("red_glazed_terracotta_side_pillar_slab", () -> new GlazedSlabBlock(GlazedTerracottaProperties("red")));
	...
	public static RegistryObject<Block> ORANGE_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB = HELPER.createBlock("orange_glazed_terracotta_side_pillar_slab", () -> new GlazedSlabBlock(GlazedTerracottaProperties("orange")));
	...
	public static RegistryObject<Block> YELLOW_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB = HELPER.createBlock("yellow_glazed_terracotta_side_pillar_slab", () -> new GlazedSlabBlock(GlazedTerracottaProperties("yellow")));
	...
	public static RegistryObject<Block> LIME_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB = HELPER.createBlock("lime_glazed_terracotta_side_pillar_slab", () -> new GlazedSlabBlock(GlazedTerracottaProperties("lime")));
	...
	public static RegistryObject<Block> GREEN_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB = HELPER.createBlock("green_glazed_terracotta_side_pillar_slab", () -> new GlazedSlabBlock(GlazedTerracottaProperties("green")));
	...
	public static RegistryObject<Block> CYAN_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB = HELPER.createBlock("cyan_glazed_terracotta_side_pillar_slab", () -> new GlazedSlabBlock(GlazedTerracottaProperties("cyan")));
	...
	public static RegistryObject<Block> LIGHT_BLUE_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB = HELPER.createBlock("light_blue_glazed_terracotta_side_pillar_slab", () -> new GlazedSlabBlock(GlazedTerracottaProperties("light_blue")));
	...
	public static RegistryObject<Block> BLUE_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB = HELPER.createBlock("blue_glazed_terracotta_side_pillar_slab", () -> new GlazedSlabBlock(GlazedTerracottaProperties("blue")));
	...
	public static RegistryObject<Block> PURPLE_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB = HELPER.createBlock("purple_glazed_terracotta_side_pillar_slab", () -> new GlazedSlabBlock(GlazedTerracottaProperties("purple")));
	...
	public static RegistryObject<Block> MAGENTA_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB = HELPER.createBlock("magenta_glazed_terracotta_side_pillar_slab", () -> new GlazedSlabBlock(GlazedTerracottaProperties("magenta")));
	...
	public static RegistryObject<Block> PINK_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB = HELPER.createBlock("pink_glazed_terracotta_side_pillar_slab", () -> new GlazedSlabBlock(GlazedTerracottaProperties("pink")));
	...
	/**
	 * Sets up the properties and mapColor of the glazed terracotta block for you. Requires just the color code you use for maps from your dye code.
	 * 
	 * @param DyeColor color
	 * @return BlockBehavior.Properties for terracotta in general.
	 */
	public static Block.Properties GlazedTerracottaProperties(DyeColor dye) {
        return BlockBehaviour.Properties.copy(Blocks.STONE).mapColor(dye).requiresCorrectToolForDrops().strength(1.4F).pushReaction(PushReaction.PUSH_ONLY);
    }
	...
	public static void setupTabEditors() {
		CreativeModeTabContentsPopulator.mod(Registration.MOD_ID)
			...
			.addItems(WHITE_CENTERED_GLAZED_TERRACOTTA,
					...
					WHITE_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB,
					WHITE_CENTERED_GLAZED_TERRACOTTA_SLAB,
					GlazedItems.WHITE_GLAZED_SHARD)
			//LIGHT_GRAY
			.addItems(LIGHT_GRAY_CENTERED_GLAZED_TERRACOTTA,
					...
					LIGHT_GRAY_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB,
					LIGHT_GRAY_CENTERED_GLAZED_TERRACOTTA_SLAB,
					GlazedItems.LIGHT_GRAY_GLAZED_SHARD)
			//GRAY
			.addItems(GRAY_CENTERED_GLAZED_TERRACOTTA,
					...
					GRAY_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB,
					GRAY_CENTERED_GLAZED_TERRACOTTA_SLAB,
					GlazedItems.GRAY_GLAZED_SHARD)
			//BLACK
			.addItems(BLACK_CENTERED_GLAZED_TERRACOTTA,
					...
					BLACK_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB,
					BLACK_CENTERED_GLAZED_TERRACOTTA_SLAB,
					GlazedItems.BLACK_GLAZED_SHARD)
			//BROWN
			.addItems(BROWN_CENTERED_GLAZED_TERRACOTTA,
					...
					BROWN_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB,
					BROWN_CENTERED_GLAZED_TERRACOTTA_SLAB,
					GlazedItems.BROWN_GLAZED_SHARD)
			//RED
			.addItems(RED_CENTERED_GLAZED_TERRACOTTA,
					...
					RED_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB,
					RED_CENTERED_GLAZED_TERRACOTTA_SLAB,
					GlazedItems.RED_GLAZED_SHARD)
			//ORANGE
			.addItems(ORANGE_CENTERED_GLAZED_TERRACOTTA,
					...
					ORANGE_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB,
					ORANGE_CENTERED_GLAZED_TERRACOTTA_SLAB,
					GlazedItems.ORANGE_GLAZED_SHARD)
			//YELLOW
			.addItems(YELLOW_CENTERED_GLAZED_TERRACOTTA,
					...
					YELLOW_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB,
					YELLOW_CENTERED_GLAZED_TERRACOTTA_SLAB,
					GlazedItems.YELLOW_GLAZED_SHARD)
			//LIME
			.addItems(LIME_CENTERED_GLAZED_TERRACOTTA,
					...
					LIME_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB,
					LIME_CENTERED_GLAZED_TERRACOTTA_SLAB,
					GlazedItems.LIME_GLAZED_SHARD)
			//GREEN
			.addItems(GREEN_CENTERED_GLAZED_TERRACOTTA,
					...
					GREEN_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB,
					GREEN_CENTERED_GLAZED_TERRACOTTA_SLAB,
					GlazedItems.GREEN_GLAZED_SHARD)
			//CYAN
			.addItems(CYAN_CENTERED_GLAZED_TERRACOTTA,
					...
					CYAN_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB,
					CYAN_CENTERED_GLAZED_TERRACOTTA_SLAB,
					GlazedItems.CYAN_GLAZED_SHARD)
			//LIGHT_BLUE
			.addItems(LIGHT_BLUE_CENTERED_GLAZED_TERRACOTTA,
					...
					LIGHT_BLUE_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB,
					LIGHT_BLUE_CENTERED_GLAZED_TERRACOTTA_SLAB,
					GlazedItems.LIGHT_BLUE_GLAZED_SHARD)
			//BLUE
			.addItems(BLUE_CENTERED_GLAZED_TERRACOTTA,
					...
					BLUE_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB,
					BLUE_CENTERED_GLAZED_TERRACOTTA_SLAB,
					GlazedItems.BLUE_GLAZED_SHARD)
			//PURPLE
			.addItems(PURPLE_CENTERED_GLAZED_TERRACOTTA,
					...
					PURPLE_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB,
					PURPLE_CENTERED_GLAZED_TERRACOTTA_SLAB,
					GlazedItems.PURPLE_GLAZED_SHARD)
			//MAGENTA
			.addItems(MAGENTA_CENTERED_GLAZED_TERRACOTTA,
					...
					MAGENTA_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB,
					MAGENTA_CENTERED_GLAZED_TERRACOTTA_SLAB,
					GlazedItems.MAGENTA_GLAZED_SHARD)
			//PINK
			.addItems(PINK_CENTERED_GLAZED_TERRACOTTA,
					...
					PINK_GLAZED_TERRACOTTA_SIDE_PILLAR_SLAB,
					PINK_CENTERED_GLAZED_TERRACOTTA_SLAB,
					GlazedItems.PINK_GLAZED_SHARD);
	}
}
